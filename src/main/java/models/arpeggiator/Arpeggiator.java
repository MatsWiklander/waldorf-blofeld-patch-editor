...
public class Arpeggiator {
        ...
        private final main.java.models.arpeggiator.patterns.Patterns patterns;

        public Arpeggiator(final PatchData patchData) {
                this.patchData = patchData;

                patterns = new main.java.models.arpeggiator.patterns.Patterns(
                                patchData);
        ...
        public final main.java.models.arpeggiator.patterns.Patterns getPatterns() {
                return patterns;
        }
