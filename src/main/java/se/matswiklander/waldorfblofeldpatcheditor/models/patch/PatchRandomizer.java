...
import main.java.se.matswiklander.waldorfblofeldpatcheditor.models.oscillators.OscillatorBase;
...
public class PatchRandomizer {
        ...
        private void randomizeArpeggiatorStep(final PatternBase patternBase) {
                ...
                patternBase.setLength(main.java.se.matswiklander.waldorfblofeldpatcheditor.models.arpeggiator.patterns.Lengths
                                .values()[generateRandomValue(
                                0,
                                main.java.se.matswiklander.waldorfblofeldpatcheditor.models.arpeggiator.patterns.Lengths
                                                .values().length - 1)]);
