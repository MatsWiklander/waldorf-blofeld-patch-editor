...
public class Delay implements Overlayable {
        ...
        public final ZeroToPlus127 getLength() {
        ...
        public final void setLength(final ZeroToPlus127 length) {
                effectBase.setParameter4(length);
        }
